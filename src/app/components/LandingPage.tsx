...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen relative bg-[var(--bg-base)] text-[var(--text-primary)] font-sans overflow-x-hidden pb-24 md:pb-0`}>
        ...
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-[var(--bg-base)]/90 backdrop-blur-md py-3 shadow-lg border-b border-white/5' : 'bg-transparent py-5'}`}>
          <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-display text-xl md:text-3xl tracking-wider leading-none">CRUZE</h1>
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="flex flex-col gap-8 text-center text-4xl font-serif">
                {['Home', 'Services', 'Process', 'Contact'].map(item => (
        ...
        <section id="home" className="relative overflow-hidden">
          ...
          >
            ...
            <div ref={heroRef} className="max-w-7xl mx-auto">
              ...
              <div className="text-[clamp(2.5rem,8vw,8rem)] leading-[0.9] font-display tracking-wide mb-4 text-white drop-shadow-2xl overflow-hidden">
                <TextRotate
              ...
              <h3 className="text-xl md:text-4xl font-serif text-[var(--text-muted)] mb-6 uppercase tracking-widest">
                Your Gateway to a Maritime Career
              </h3>

              <p className="text-base md:text-xl text-[var(--text-muted)] max-w-2xl mb-10 leading-relaxed">
                Crew Manning · College Admissions · Courses · Passport Services — from Tuticorin to the world's oceans.
              </p>

              <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                <MagneticButton href="#services" className="w-full md:w-auto px-8 py-4 bg-[var(--accent)] hover:bg-[var(--accent-warm)] transition-colors text-black font-semibold rounded-sm tracking-wide text-center">
                  Our Services
                </MagneticButton>
                <MagneticButton href="https://wa.me/919003354028" className="w-full md:w-auto px-8 py-4 border border-[var(--border)] hover:border-[var(--accent)] transition-colors text-white font-semibold rounded-sm tracking-wide backdrop-blur-sm bg-white/5 text-center">
                  WhatsApp Us
                </MagneticButton>
              </div>
            </div>
        ...
        {/* Mobile Sticky Bar */}
        <div className="md:hidden fixed bottom-0 left-0 w-full bg-[var(--bg-surface)] border-t border-white/10 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] flex gap-4 z-40">
